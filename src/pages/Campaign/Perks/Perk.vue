      ...
      <div class="row">
        <div class="col-12 col-lg-10">
          ...
          <div class="entreField">
            ...
            />
            <span class="error-message" v-if="errors.quantity">{{
              errors.quantity
            }}</span>
          </div>
          <div class="mt-4">
...
export default {
  ...
  methods: {
    ...
    validate: function () {
      ...
      if (!this.perk.price || this.perk.price <= 0) {
        if (this.perk.price <= 0)
          this.errors.price = "Price should be higher than 0";
        if (!this.perk.price) this.errors.price = "Price is required";
      ...
      if (this.perk.quantity && this.perk.quantity <= 0) {
        isValid = false;
        this.errors.quantity = "Quantity should be higher than 0";
      } else this.errors.quantity = "";
